...
(cl:defmethod cl:initialize-instance :after ((m <VrepInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VrepInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tapir-msg:<VrepInfo> is deprecated: use tapir-msg:VrepInfo instead.")))

(cl:ensure-generic-function 'headerInfo-val :lambda-list '(m))
(cl:defmethod headerInfo-val ((m <VrepInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tapir-msg:headerInfo-val is deprecated.  Use tapir-msg:headerInfo instead.")
  (headerInfo m))

(cl:ensure-generic-function 'simulatorState-val :lambda-list '(m))
(cl:defmethod simulatorState-val ((m <VrepInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tapir-msg:simulatorState-val is deprecated.  Use tapir-msg:simulatorState instead.")
  (simulatorState m))

(cl:ensure-generic-function 'simulationTime-val :lambda-list '(m))
(cl:defmethod simulationTime-val ((m <VrepInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tapir-msg:simulationTime-val is deprecated.  Use tapir-msg:simulationTime instead.")
  (simulationTime m))

(cl:ensure-generic-function 'timeStep-val :lambda-list '(m))
(cl:defmethod timeStep-val ((m <VrepInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tapir-msg:timeStep-val is deprecated.  Use tapir-msg:timeStep instead.")
  (timeStep m))
