...
(cl:defmethod cl:initialize-instance :after ((m <simRosLoadScene-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'simRosLoadScene-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tapir-srv:<simRosLoadScene-request> is deprecated: use tapir-srv:simRosLoadScene-request instead.")))

(cl:ensure-generic-function 'fileName-val :lambda-list '(m))
(cl:defmethod fileName-val ((m <simRosLoadScene-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tapir-srv:fileName-val is deprecated.  Use tapir-srv:fileName instead.")
  (fileName m))
...
(cl:defmethod cl:initialize-instance :after ((m <simRosLoadScene-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'simRosLoadScene-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tapir-srv:<simRosLoadScene-response> is deprecated: use tapir-srv:simRosLoadScene-response instead.")))
