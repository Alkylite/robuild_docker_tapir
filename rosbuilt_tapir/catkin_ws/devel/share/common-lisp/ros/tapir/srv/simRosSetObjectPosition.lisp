...
(cl:defmethod cl:initialize-instance :after ((m <simRosSetObjectPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'simRosSetObjectPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tapir-srv:<simRosSetObjectPosition-request> is deprecated: use tapir-srv:simRosSetObjectPosition-request instead.")))

(cl:ensure-generic-function 'handle-val :lambda-list '(m))
(cl:defmethod handle-val ((m <simRosSetObjectPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tapir-srv:handle-val is deprecated.  Use tapir-srv:handle instead.")
  (handle m))
...
(cl:defmethod relativeToObjectHandle-val ((m <simRosSetObjectPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tapir-srv:relativeToObjectHandle-val is deprecated.  Use tapir-srv:relativeToObjectHandle instead.")
  (relativeToObjectHandle m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <simRosSetObjectPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tapir-srv:position-val is deprecated.  Use tapir-srv:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<simRosSetObjectPosition-request>)))
  ...
  "tapir/simRosSetObjectPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'simRosSetObjectPosition-request)))
  "Returns string type for a service object of type 'simRosSetObjectPosition-request"
  "tapir/simRosSetObjectPositionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <simRosSetObjectPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'simRosSetObjectPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tapir-srv:<simRosSetObjectPosition-response> is deprecated: use tapir-srv:simRosSetObjectPosition-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <simRosSetObjectPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tapir-srv:result-val is deprecated.  Use tapir-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<simRosSetObjectPosition-response>)))
  ...
  "tapir/simRosSetObjectPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'simRosSetObjectPosition-response)))
  "Returns string type for a service object of type 'simRosSetObjectPosition-response"
  "tapir/simRosSetObjectPositionResponse")
